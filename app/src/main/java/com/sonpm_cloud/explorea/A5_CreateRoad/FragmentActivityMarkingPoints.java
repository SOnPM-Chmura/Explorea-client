...
public class FragmentActivityMarkingPoints extends AbstractGoogleMapContainerFragment {
    ...
    public static FragmentActivityMarkingPoints newInstance() { return new FragmentActivityMarkingPoints(); }
